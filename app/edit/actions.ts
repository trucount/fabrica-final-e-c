...
export async function saveEditedHomeContent(formData: FormData) {
  ...
  const content: HomeContent = {
    ...
    heroImageUrls: getRequiredTextList(formData, "heroImageUrlsDesktop", destination),
    heroImageUrlsDesktop: getRequiredTextList(formData, "heroImageUrlsDesktop", destination),
    heroImageUrlsMobile: getRequiredTextList(formData, "heroImageUrlsMobile", destination),
