...
export async function saveEditedHomeContent(formData: FormData) {
  ...
  const content: HomeContent = {
    ...
    heroImageUrls: getRequiredTextList(formData, "heroImageUrlsDesktop", destination).slice(0, 4),
    heroImageUrlsDesktop: getRequiredTextList(formData, "heroImageUrlsDesktop", destination).slice(0, 4),
    heroImageUrlsMobile: getRequiredTextList(formData, "heroImageUrlsMobile", destination).slice(0, 4),
